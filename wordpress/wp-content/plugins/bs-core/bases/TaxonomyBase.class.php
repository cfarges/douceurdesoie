...
namespace Bs\Bases {
  ...
  class TaxonomyBase implements Interfaces\IWPObject, Interfaces\IMetaContainer
  {
    ...
    public static function create($source) {
      ...
      return new TaxonomyBase($source);
    }
    /**********************/
...
namespace {
  class BsTaxonomyBase extends Bs\Bases\TaxonomyBase {
    public function __construct($idOrTerm=null) {
      if ($_GET['debug']) echo 'Plugin is using BsTaxonomyBase';
      parent::__construct($idOrTerm);
    }
  }
}