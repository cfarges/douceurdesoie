...
namespace Bs\Bases {
  ...
  class UserBase implements Interfaces\IWPUser, Interfaces\IMetaContainer
  {
...
namespace {
  class BsUserBase extends Bs\Bases\UserBase {
    public function __construct($idOrPost=null) {
      if ($_GET['debug']) echo 'Plugin is using BsUserBase';
